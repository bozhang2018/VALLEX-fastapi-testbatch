        ...
        with gr.Tab("Infer from audio"):
            ...
            with gr.Row():
                with gr.Column():
                    ...
                    upload_audio_prompt = gr.Audio(label='uploaded audio prompt', sources='upload', interactive=True)
                    record_audio_prompt = gr.Audio(label='recorded audio prompt', sources='microphone', interactive=True)
                with gr.Column():
